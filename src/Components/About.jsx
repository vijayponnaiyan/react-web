...
<div class="w-full bg-white pt-7 pb-7 md:pt-20 md:pb-24">
    ...
    <div class="box-border flex  items-center content-center px-8 mx-auto mt-2 leading-6 text-black border-0 border-gray-300 border-solid md:mt-20 xl:mt-0 md:flex-row max-w-7xl lg:px-16">
