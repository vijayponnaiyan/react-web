...
export default function Reastruncard({ image, title, price, description, rating }) {
  return (
     <div className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-xl mt-5 p-4 ">
      <img
      ...
      <div className="p-4">
        ...
        <p className="text-gray-600 text-sm mt-2 max-h-16 overflow-hidden text-ellipsis">
          {description}
        </p>
